...
Použili sme klasifikátory tak, ako sme popísali v~sekcii \ref{sec:use-rf-alignment} a výsledky sa nachádzajú v~tabuľke \ref{tab:clf-results}. Pre naše experimenty sme použili okno veľkosti päť, ale ako si ukážeme v časti \ref{subsec:window-size} na veľkosti okna pri našich experimentoch nezáleží.
