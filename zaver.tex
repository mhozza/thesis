...
%, pričom sme pozerali na to, ktoré atribúty sú pre klasifikátor najdôležitejšie a ktoré sú najmenej dôležité.
...
% Dá sa použiť aj učenie bez učiteľa, kde by sa najskôr sekvencie zarovnávali niektorým existujúcim zarovnávačom a potom by sa iteratívne model natrénoval z~aktuálneho zarovnania a potom by sa prezarovnal a toto by sa opakovalo až do konvergencie.
